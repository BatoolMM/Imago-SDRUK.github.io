from this python code, generate ts types as follows: 

type NameOfFunction = [
'name_of_function',{...function_parameters}
]

take the function parameters from the comments, and also keep the comments of the parameters if there are any 

at the end create a type with all the created types: type AllTypes = Type1|Type2
